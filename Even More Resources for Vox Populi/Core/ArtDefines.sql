...
VALUES	('ICON_FONT_TEXTURE_BEER', 			'BeerFontIcon_22'),
		...
		('ICON_FONT_TEXTURE_MAIZE', 		'MaizeFontIcon_22'),
		...
		('ICON_FONT_TEXTURE_RICE', 			'RiceFontIcon_22'),
...
VALUES	('ICON_RES_BEER', 			'ICON_FONT_TEXTURE_BEER',			1),
		...
		('ICON_RES_MAIZE',			'ICON_FONT_TEXTURE_MAIZE',			1),
		...
		('ICON_RES_RICE', 			'ICON_FONT_TEXTURE_RICE',			1),
...
VALUES	('ART_DEF_RESOURCE_COCONUT',				'Resource',	'SV_Coconut.dds'),
		...
		('ART_DEF_RESOURCE_MAIZE',					'Resource',	'SV_Maize.dds'),
		...
		('ART_DEF_RESOURCE_RICE',					'Resource',	'SV_Rice.dds'),
...
VALUES	('ART_DEF_RESOURCE_COCONUT',				'Resource',		'Coconut'),
		...
		('ART_DEF_RESOURCE_MAIZE',					'Resource',		'Maize'),
		...
		('ART_DEF_RESOURCE_RICE',					'Resource',		'Rice'),
...
VALUES	
		...
		-- Maize
		('Any',				'Any',					0.9399999976158142,	'ART_DEF_IMPROVEMENT_NONE',			'SNAPSHOT',					'ART_DEF_RESOURCE_MAIZE',					'resource_maize.fxsxml',					1,				null),
		('Any',				'Any',					1.0,				'ART_DEF_IMPROVEMENT_FARM',			'SNAPSHOT',					'ART_DEF_RESOURCE_MAIZE',					null,										1,				null),
		('Any',				'UnderConstruction',	1.0,				'ART_DEF_IMPROVEMENT_FARM',			'SNAPSHOT',					'ART_DEF_RESOURCE_MAIZE',					null,										1,				null),
		('Ancient',			'UnderConstruction',	1.0,				'ART_DEF_IMPROVEMENT_FARM',			'FARM',						'ART_DEF_RESOURCE_MAIZE',					'HB_Medieval_Farm.fxsxml',					1,				null),
		('Ancient',			'Constructed',			1.0,				'ART_DEF_IMPROVEMENT_FARM',			'FARM',						'ART_DEF_RESOURCE_MAIZE',					'Medieval_Farm.fxsxml',						1,				null),
		('Ancient',			'Pillaged',				1.0,				'ART_DEF_IMPROVEMENT_FARM',			'FARM',						'ART_DEF_RESOURCE_MAIZE',					'PL_Medieval_Farm.fxsxml',					1,				null),
		('Industrial',		'UnderConstruction',	1.0,				'ART_DEF_IMPROVEMENT_FARM',			'FARM',						'ART_DEF_RESOURCE_MAIZE',					'HB_Modern_Farm.fxsxml',					1,				null),
		('Industrial',		'Constructed',			1.0,				'ART_DEF_IMPROVEMENT_FARM',			'FARM',						'ART_DEF_RESOURCE_MAIZE',					'Modern_Farm.fxsxml',						1,				null),
		('Industrial',		'Pillaged',				1.0,				'ART_DEF_IMPROVEMENT_FARM',			'FARM',						'ART_DEF_RESOURCE_MAIZE',					'PL_Modern_Farm.fxsxml',					1,				null),
		...
		-- Rice
		('Any',				'Any',					0.9399999976158142,	'ART_DEF_IMPROVEMENT_NONE',			'SNAPSHOT',					'ART_DEF_RESOURCE_RICE',					'rice_decal.fxsxml',						1,				null),
		('Any',				'Any',					1.0,				'ART_DEF_IMPROVEMENT_FARM',			'SNAPSHOT',					'ART_DEF_RESOURCE_RICE',					null,										1,				null),
		('Any',				'UnderConstruction',	1.0,				'ART_DEF_IMPROVEMENT_FARM',			'SNAPSHOT',					'ART_DEF_RESOURCE_RICE',					null,										1,				null),
		('Ancient',			'UnderConstruction',	1.0,				'ART_DEF_IMPROVEMENT_FARM',			'FARM',						'ART_DEF_RESOURCE_RICE',					'HB_Medieval_Farm.fxsxml',					1,				null),
		('Ancient',			'Constructed',			1.0,				'ART_DEF_IMPROVEMENT_FARM',			'FARM',						'ART_DEF_RESOURCE_RICE',					'Medieval_Farm.fxsxml',						1,				null),
		('Ancient',			'Pillaged',				1.0,				'ART_DEF_IMPROVEMENT_FARM',			'FARM',						'ART_DEF_RESOURCE_RICE',					'PL_Medieval_Farm.fxsxml',					1,				null),
		('Industrial',		'UnderConstruction',	1.0,				'ART_DEF_IMPROVEMENT_FARM',			'FARM',						'ART_DEF_RESOURCE_RICE',					'HB_Modern_Farm.fxsxml',					1,				null),
		('Industrial',		'Constructed',			1.0,				'ART_DEF_IMPROVEMENT_FARM',			'FARM',						'ART_DEF_RESOURCE_RICE',					'Modern_Farm.fxsxml',						1,				null),
		('Industrial',		'Pillaged',				1.0,				'ART_DEF_IMPROVEMENT_FARM',			'FARM',						'ART_DEF_RESOURCE_RICE',					'PL_Modern_Farm.fxsxml',					1,				null),
