...
SET Value = 1
WHERE Name = 'RESOURCES_PRODUCTION_COST_MODIFIERS' OR Name = 'EVENTS_TILE_IMPROVEMENTS';
--==========================================================================================================================
-- RESOURCES
--==========================================================================================================================
---- Resources
...
INSERT INTO Resources
		(Type)
VALUES	('RESOURCE_BEER'),
		('RESOURCE_BIRDS_NEST'),
		('RESOURCE_CHAMPAGNE'),
		('RESOURCE_CHEESE'),
		('RESOURCE_HONEY'),
		('RESOURCE_MANUSCRIPTS');
...
UPDATE Resources SET
	...
	MaxLatitude = 90,
	IsMonopoly = 0
WHERE Type IN('RESOURCE_COCONUT', 'RESOURCE_HARDWOOD', 'RESOURCE_LEAD', 'RESOURCE_MAIZE', 'RESOURCE_PINEAPPLE', 'RESOURCE_POTATO', 'RESOURCE_RICE', 'RESOURCE_RUBBER', 'RESOURCE_SULFUR', 'RESOURCE_TITANIUM');
...
--- Maize
UPDATE Resources SET
	Description = 'TXT_KEY_RESOURCE_MAIZE',
	Civilopedia = 'TXT_KEY_CIV5_RESOURCE_MAIZE_TEXT',
	--Help = 'TXT_KEY_RESOURCE_MAIZE_HELP',
	ArtDefineTag = 'ART_DEF_RESOURCE_MAIZE',
	IconString = '[ICON_RES_MAIZE]',
	PortraitIndex = 12,
	IconAtlas = 'EVEN_MORE_RESOURCES_ATLAS_A',
	Hills = 0,
	Flatlands = 1,
	TechReveal = 'TECH_AGRICULTURE',
	TechCityTrade = 'TECH_AGRICULTURE'
...
--- Rice
UPDATE Resources SET
	Description = 'TXT_KEY_RESOURCE_RICE',
	Civilopedia = 'TXT_KEY_CIV5_RESOURCE_RICE_TEXT',
	--Help = 'TXT_KEY_RESOURCE_RICE_HELP',
	ArtDefineTag = 'ART_DEF_RESOURCE_RICE',
	IconString = '[ICON_RES_RICE]',
	PortraitIndex = 11,
	IconAtlas = 'EVEN_MORE_RESOURCES_ATLAS_A',
	Hills = 0,
	Flatlands = 1,
...
INSERT INTO Improvement_ResourceTypes
		(ResourceType, ImprovementType)
SELECT	Type, 'IMPROVEMENT_FARM'
FROM Resources WHERE Type IN ('RESOURCE_MAIZE', 'RESOURCE_RICE');

INSERT INTO Improvement_ResourceTypes -- this is just to prevent the bug where the resource graphic shows up when you put a GPTI on the tile
		(ResourceType, ImprovementType)
SELECT	r.Type, i.Type
FROM Resources r, Improvements i WHERE r.Type IN('RESOURCE_COCONUT', 'RESOURCE_HARDWOOD', 'RESOURCE_LEAD', 'RESOURCE_MAIZE', 'RESOURCE_PINEAPPLE', 'RESOURCE_POTATO', 'RESOURCE_RICE', 'RESOURCE_RUBBER', 'RESOURCE_SULFUR', 'RESOURCE_TITANIUM') AND i.CreatedByGreatPerson = 1;
----------------------------------------------------------------------------------------------------------------------------
...
INSERT INTO Building_ResourceYieldChanges
		(BuildingType, ResourceType, YieldType, Yield)
SELECT	bco.BuildingType, r.Type, ryc.YieldType, ryc.Yield
...
INSERT INTO Building_LocalResourceOrs
		(BuildingType, ResourceType)
SELECT	bco.BuildingType, r.Type
...
SELECT	rmo.CorporationType, rmo.ResourceType, ryc.YieldType, ryc.Yield
