--=======================================================================================================================
-- HFF_SaveUtils
-- Modified from Sukritact_SaveUtils, which in turn is modified from NewSaveUtils.lua
-- The only change in HFF_SaveUtils is the new function OpenSaveData, which allows you to reopen the save data
--=======================================================================================================================
